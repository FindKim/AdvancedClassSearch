	...
	function getEventData() {
		...
		return {
			events : [
				{
					"id":1,
					"start": new Date(year, month, 8, 8, 20),
					"end": new Date(year, month, 8, 9, 10),
					"title":"General Physics I, 20886, 01"
				},
				{
					"id":2,
         		                "start": new Date(year, month, 10, 8, 20),
                   		        "end": new Date(year, month, 10, 9, 10),
					"title":"General Physics I, 20886, 01"
				},
				{
					"id":3,
                         		"start": new Date(year, month, 12, 8, 20),
           	              	 	 "end": new Date(year, month, 12, 9, 10),
					"title":"General Physics I, 20886, 01"
				},
				{
					"id":4,
                         		"start": new Date(year, month, 12, 13, 55),
           	              	 	 "end": new Date(year, month, 12, 15, 50),
					"title":"General Physics I Laboratory, 21368, 01"
				},
				{
					"id":5,
	      	 	                  "start": new Date(year, month, 9,17, 05),
   		                        "end": new Date(year, month, 9, 17, 55),
